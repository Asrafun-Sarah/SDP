  ...
  const loadDashboardData = async () => {
    try {
      ...
      const [statsData, receivedData, sentData] = await Promise.all([
        ...
        apiFetch<HelpRequest[]>("/api/requests/received"),
        apiFetch<HelpRequest[]>("/api/requests/sent"),
      ]);
      ...
      >
        ...
        <div>
          ...
          {receivedRequests.length === 0 ? (
            ...
            >
              You haven't received any help requests yet. As you upload more
              projects, peers working on similar topics will reach out!
            </div>
          ) : (
            <div
              style={{
                ...
                >
                  ...
                  >
                    ...
                    >
                      ...
                      <span>
                        {req.requester?.full_name || "Unknown Student"} (
                        {req.requester?.department || "Unknown Department"})
                      </span>
                    </div>
                    ...
                    {req.status === "Pending" ? (
                      ...
                      >
                        Email: {req.requester?.email || "Not available"}
                      </div>
                    ) : null}
                  </div>
                </div>
        ...
        <div>
          ...
          {sentRequests.length === 0 ? (
            ...
            >
              You haven't requested help on any project yet. Browse projects
              to connect with experienced peers!
            </div>
          ) : (
            <div
              style={{
              ...
              {sentRequests.map((req) => (
                ...
                >
                  ...
                  >
                    <span>
                      Sent to:{" "}
                      {req.recipient?.full_name || "Unknown Student"}
                    </span>
                    ...
                    {req.status === "Accepted" && (
                      ...
                      >
                        Peer Email:{" "}
                        {req.recipient?.email || "Not available"}
                      </span>
                    )}
                  </div>
                </div>
