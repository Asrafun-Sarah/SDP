...
export default function LoginPage() {
  ...
  return (
    <div className="container" style={{ padding: "5rem 1.5rem", maxWidth: "460px" }}>
      <div className="glass-card" style={{ padding: "2.5rem" }}>
        <div style={{ textAlign: "center", marginBottom: "2rem" }}>
          ...
          <h1 style={{ fontSize: "1.75rem", fontWeight: 800 }}>Student Log In</h1>
        ...
        <div style={{ textAlign: "center", marginTop: "1.5rem", fontSize: "0.875rem", color: "var(--text-muted)" }}>
          ...
          <Link href="/register" style={{ color: "var(--primary-cyan)", fontWeight: 600 }}>
            Sign Up here
          </Link>
        </div>
      </div>
